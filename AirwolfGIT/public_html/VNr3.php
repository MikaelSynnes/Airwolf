...
<html>
    ...
    <body>
        ...
        <div id="product">
            ...
            <select name="VNr"><option value=<?php echo$rows[2]['VNr'] ?>/>
            </select>



            <?php echo $rows[2]['Beskrivelse']; ?>
            <br>
            <select name="pris"> <option value= <?php echo $rows[2]['Pris'];
            ?>/></select>
            <p><?php echo $rows[2]['Pris'] ?>kr</p>
